...
<!-- Transformační šablona náhledu pro závazky ve tvaru HTML. Doklad se zobrazuje jako náhled dokladu před tiskem. - SK lokalizácia
Autor: Marek Vykydal
 -->
	...
	<!-- -->
	<xsl:template match="SeznamZavazku">
		<xsl:apply-templates select="Zavazek">
			<xsl:with-param name="Pocet" select="count(Zavazek)"/>
		</xsl:apply-templates>
	</xsl:template>
			...
			<tr>
				...
				<td class="zarovnani_N" width="48.5%">
					<table bordercolor="black" width="100%" cellspacing="0" cellpadding="0" border="0">
						<tbody>
							<tr>
								<td class="velikost1 tucne podtrzeni_N3" align="left" height="32">Záväzok</td>
							</tr>
						</tbody>
					</table>
				</td>
				...
				<td class="zarovnani_N" rowspan="2">
					<table bordercolor="black" width="100%" cellspacing="0" cellpadding="0" border="0">
						<tbody>
							...
							<tr>	<td class="velikost4 tucne podtrzeni_D" colspan="3">Dodávateľ:</td>
							</tr>
