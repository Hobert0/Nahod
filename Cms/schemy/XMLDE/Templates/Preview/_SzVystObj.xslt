...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:template match="SeznamObjVyd">
		<html>
			<head>
				<title>Seznam vystavených objednávek</title>
				<style><![CDATA[
			...
			<body onload="Init();">
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					<tr>
						<td class="velikost1 tucne podtrzeni_D3" align="left" height="35" colspan="11">Zoznam vystavených objednávokk</td>
					</tr>
					<tr>
						<td height="20"/>
					</tr>
					...
					<tr>
						...
						<td class="velikost5 tucne podtrzeni_D"  width="8%" align="left" >Vybaviť do</td>
					...
					<xsl:apply-templates select="ObjVyd"></xsl:apply-templates>
					...
					<tr>
						<td class="velikost5 podtrzeni_N" height="25" colspan="11">Vytlačil(a): &#32;<span id="Datum"></span></td>
					</tr>
