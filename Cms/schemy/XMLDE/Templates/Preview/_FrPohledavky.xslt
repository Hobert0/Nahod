...
<!-- Transformační šablona náhledu pro pohledávky ve tvaru HTML. Doklad se zobrazuje jako náhled dokladu před tiskem - Sk lokalizácia.
Autor: Marek Vykydal
 -->
	...
	<!-- -->
	<xsl:template match="SeznamPohledavek">
		<xsl:apply-templates select="Pohledavka">
			<xsl:with-param name="Pocet" select="count(Pohledavka)"/>
		</xsl:apply-templates>
	</xsl:template>
					...
					<table bordercolor="black" width="100%" cellspacing="0" cellpadding="0" border="0">
						<tbody>
							...
							<tr>
								...
								<td class="velikost3 tucne zarovnani_N" align="right" width="5%">IČO:<br/>DIČ:<br/>IČ DPH:</td>
								<td class="velikost3 tucne zarovnani_N" width="13%">
										&#160;&#160;<xsl:value-of select="MojeFirma/ICO" /><br/>
										&#160;&#160;<xsl:value-of select="MojeFirma/DanIC" /><br/>
			...
			<tr>
				...
				<td class="zarovnani_N" width="48.5%">
					<table bordercolor="black" width="100%" cellspacing="0" cellpadding="0" border="0">
						<tbody>
							<tr>
								<td class="velikost1 tucne podtrzeni_N3" align="left" height="32">Pohľadávka</td>
							</tr>
						</tbody>
					</table>
				</td>
				...
				<td class="zarovnani_N" rowspan="2">
					<table bordercolor="black" width="100%" cellspacing="0" cellpadding="0" border="0">
						<tbody>
							...
							<tr>	<td class="velikost4 tucne podtrzeni_D" colspan="3">Odberateľ:</td>
							</tr>
				...
				<td class="zarovnani_N">
					<table bordercolor="black" width="100%" cellspacing="0" cellpadding="0" border="0">
						<tbody>
							...
							<tr>
								<td class="velikost4" height="17" align="right">dodania:</td>
								<td/>
								<td class="velikost4" align="center">
							...
							<tr>
								<td class="velikost4" height="17" align="right">splatnosti:</td>
								<td/>
								<td class="velikost4" align="center">
									<xsl:if test="string-length(DatSpl)>0">
										<xsl:call-template name="_datum_">
											<xsl:with-param name="_datum">
												<xsl:value-of select="DatSpl"/>
											</xsl:with-param>
										</xsl:call-template>
									</xsl:if>
								</td>
			...
			<!-- zaúčtoval, schválil, podpisy -->
				<td colspan="3">
					<table class="podtrzeni_N podtrzeni_D podtrzeni_L podtrzeni_P" bordercolor="black" width="100%" cellspacing="0" cellpadding="5" border="0">
						<tbody>
							<tr>
								<td class="velikost4 podtrzeni_P" width="33%">
									Vystavil(a): <xsl:value-of select="Vyst" /><br/>
									Dňa:
									<xsl:if test="string-length(DatVyst)>0">
								...
								<td class="velikost4 podtrzeni_P zarovnani_N" width="33%">Schválil(a):</td>
								...
								<xsl:for-each select="SeznamNormPolozek/NormPolozka">
									<tr>
										...
										<td class="velikost5 podtrzeni_NT" align="right">
											...
											<xsl:if test="CenaTyp='2' ">iba DPH</xsl:if>
											<xsl:if test="CenaTyp='3' ">iba základ</xsl:if>
										</td>
									</tr>
			...
			<!-- cenový přehled dokladu -->
				...
				<td>
					<table bordercolor="black" width="100%" cellspacing="0" cellpadding="0" border="0">
						<tbody>
						<tr>
							<td class="velikost2 tucne" height="25" align="right" width="43%">Celkem s DPH:&#160;&#160;</td>
