...
<!-- Transformační šablona náhledu pro nabídky přijaté ve tvaru HTML. Doklad se zobrazuje jako náhled dokladu před tiskem. - SK lokalizácia 
Autor: Marek Vykydal
 -->
	...
	<!-- -->
	<xsl:template match="SeznamNabPrij">
		<xsl:apply-templates select="NabPrij">
			<xsl:with-param name="Pocet" select="count(NabPrij)"/>
		</xsl:apply-templates>
	</xsl:template>
				...
				<td class="zarovnani_N" rowspan="2">
					<table bordercolor="black" width="100%" cellspacing="0" cellpadding="0" border="0">
						<tbody>
							...
							<tr>
								<td class="velikost4 tucne">Doklad došlý:</td>
								<td class="velikost3 tucne pozadi1" align="center" colspan="2"><xsl:value-of select="PrimDoklad"/></td>
							</tr>
							
							<tr>	<td height="5" colspan="3"></td></tr>
							<tr>	<td class="velikost4 tucne podtrzeni_D" colspan="3">Dodávateľ</td></tr>
