...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:template match="SeznamPoptVyd">
		<html>
			<head>
				<title>Zoznam vystavených dopytov</title>
				<style><![CDATA[
			...
			<body onload="Init();">
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					<tr>
						<td class="velikost1 tucne podtrzeni_D3" align="left" height="35" colspan="11">Zoznam vystavených dopytov</td>
					</tr>
					<tr>
						<td height="20"/>
					</tr>
					...
					<xsl:apply-templates select="PoptVyd"></xsl:apply-templates>
