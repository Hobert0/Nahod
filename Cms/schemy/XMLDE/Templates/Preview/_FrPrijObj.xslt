...
<!-- Transformační šablona náhledu pro objednávky přijaté ve tvaru HTML. Doklad se zobrazuje jako náhled dokladu před tiskem.
Autor: Marek Vykydal
 -->
	...
	<!-- -->
	<xsl:template match="SeznamObjPrij">
		<xsl:apply-templates select="ObjPrij">
			<xsl:with-param name="Pocet" select="count(ObjPrij)"/>
		</xsl:apply-templates>
	</xsl:template>
				...
				<td class="zarovnani_N" rowspan="2">
					<table bordercolor="black" width="100%" cellspacing="0" cellpadding="0" border="0">
						<tbody>
							...
							<tr>
								<td class="velikost4 tucne" height="17" align="right">vybaviť do:</td>
								<td/>
