...
<!-- Transformační šablona náhledu určená pro zobrazení výstupní zprávy z generování periodických faktur ve tvaru HTML. -->
  ...
  <xsl:preserve-space elements="*"/>
	...
	<html>
		<head>
			<title>Periodická fakturácia</title>
			<style><![CDATA[
        h1 {font-size: 160%}
        h2 {font-size: 150%}
        h3 {font-size: 140%}
	...
	.radius {border-radius: 10px;}    
		...
		<body>
			<xsl:apply-templates>
				<xsl:with-param name="NadpisPerFakt">Periodická fakturácia - výstupná správa</xsl:with-param>
			</xsl:apply-templates>
		</body>
	</html>
	</xsl:template>
