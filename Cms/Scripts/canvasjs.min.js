        ...
        if (!db) {
            ...
            if (m.creditHref && m.creditText) {
                m._creditLink || (m._creditLink = document.createElement("a"), m._creditLink.setAttribute("class", "canvasjs-chart-credit"), m._creditLink.setAttribute("title", "JavaScript Charts"), m._creditLink.setAttribute("style", "outline:none;margin:0px;position:absolute;right:2px;top:" +
                    "0px;color:dimgrey;text-decoration:none;font-size:0px;font-family: Calibri, Lucida Grande, Lucida Sans Unicode, Arial, sans-serif"), m._creditLink.setAttribute("tabIndex", -1), m._creditLink.setAttribute("target", "_blank"));
    ...
    (function() {
        ...
        W._fTWm = function(m) {
            if ("undefined" === typeof W.pro.sCH && !Za) try {
                ...
                s[W.fSDec(W.obj.fnt)] = 0 + W.fSDec(W.obj.fntStr);
                s[W.fSDec(W.obj.fSy)] = W.fSDec(W.obj.grClr);
                s[W.fSDec(W.obj.fTx)](W.fSDec(W.obj.trVs), 2, m.height - 0 - 2)
            } catch (q) {}
        }
    })();
    var Va = {},
